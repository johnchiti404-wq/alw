            ...
            <>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 space-y-2">
                ...
                <div className="flex justify-between pt-2 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <span className="text-lg font-bold text-gray-900 dark:text-white">R {vehicle?.price || 0}</span>
                </div>
              </div>
            </>
          ) : isStoreDelivery ? (
            <>
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">R {orderData.subtotal || orderData.foodSubtotal || 0}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-600 dark:text-gray-300">Delivery fee</span>
                  <span className="font-medium text-gray-900 dark:text-white">R {orderData.deliveryFee || 0}</span>
                </div>
                <div className="flex justify-between pt-2 border-t border-gray-200 dark:border-gray-700">
                  <span className="font-semibold text-gray-900 dark:text-white">Total</span>
                  <span className="text-lg font-bold text-gray-900 dark:text-white">R {orderData.totalPrice || 0}</span>
                </div>
              </div>
            </>
          ) : isRide && rideData ? (
              ...
              <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 space-y-2">
                ...
                {rideData.originalPrice !== rideData.estimatedPrice && (
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-500 dark:text-gray-400 line-through">R {rideData.originalPrice}</span>
                  </div>
                )}
                <div className="flex justify-between text-sm">
                ...
                <div className="flex justify-between pt-2 border-t border-gray-200 dark:border-gray-700">
                  <span className="font-semibold text-gray-900 dark:text-white">Total</span>
                  <span className="text-lg font-bold text-gray-900 dark:text-white">R {rideData.estimatedPrice}</span>
                </div>
              </div>
            </>
          ) : (
